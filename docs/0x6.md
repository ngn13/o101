...
Şimdi 
Eğer benim açıklamamı sevmezseniz, [glibc wiki sayfasını](https://sourceware.org/glibc/wiki/MallocInternals?action=AttachFile&do=get&target=MallocInternals-chunk-inuse.svg) inceleyebilirsiniz.
